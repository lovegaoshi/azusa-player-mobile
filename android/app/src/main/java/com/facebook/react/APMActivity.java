...
// this file should be exactly the same as ReactActivity.
...
public abstract class APMActivity extends ReactActivity
    ...
    public void resumeReactFragment() {
        mDelegate.onResume();
    }
